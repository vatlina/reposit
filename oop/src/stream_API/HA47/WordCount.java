...
/*Задача 3
        ...
        Метод должен возвращать количество слов первой строки, начинающихся со второй строки.
...
public class WordCount {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Если вторая строка 'a', ответ " + count1);
        System.out.println("Если вторая строка 'aaa', ответ " + count2);
        System.out.println("Если вторая строка 'aaaa', ответ " + count3);
    }
}